# Salt Edge Integration Service demo for Backbase DBS Service


This service enables you to setup a Salt Edge integration service to:

- Categorize transactions

## Components

#### Salt Edge Integration Specification

Module contains a RAML file that contains the definition of the contracts that is going
to be exposed.


#### Salt Edge Integration Service

Component that makes the actual integration with Salt Edge API.
...
The following properties have to be set and obtained from your Salt Edge Application.
...
java jar -DSIG_SECRET_KEY=**** \
    -Dintegration.saltedge.appId=**** \
    -Dintegration.saltedge.secret=**** \
    saltedge-integration-service-1.0.0-boot.war
```
